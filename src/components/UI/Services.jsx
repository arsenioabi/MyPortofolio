                                ...
                                <div className='flex justify-start w-full mx-auto items-center'>
                                    <div className='w-full sm:w-1/2 sm:pr-8'>
                                        <div data-aos='fade-right' data-aos-duration='1200' className='bg-white p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150'>
                                            <h3 className='text-primaryColor font-[700] mb-3 group-hover:text-white group-hover:font-[600] text-xl'> Quality Assurance Software Tester</h3>
                                            <p className='text-[15px] text-smallTextColor text-justify group-hover:text-white group-hover:font-[500] leading-7'> A Quality Assurance Software Tester with expertise in manual and automation testing. I focus on ensuring product quality through structured test design and execution, efficient automation scripting, and accurate defect analysis. With precision and a methodical approach to work, I support the development process to produce stable, reliable, and user-ready software.</p>
                                        </div>
                                    </div>
                                </div>
